...
import img2 from "../Assets/real (1).jpg";
import img3 from "../Assets/real (2).jpeg";
import img4 from "../Assets/real (2).jpg";
import img5 from "../Assets/real (3).jpeg";
import img6 from "../Assets/real (3).jpg";
import img7 from "../Assets/real (4).jpeg";
import img8 from "../Assets/real (4).jpg";
import img9 from "../Assets/real (5).jpeg";
import img10 from "../Assets/real (5).jpg";
