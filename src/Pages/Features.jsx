...
<img src={img}/>
    ...
    <h3 className='Belleza'>Project features</h3>
...
areas</li>
 <li className='f-tab7'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-lamp-icon lucide-lamp"><path d="M12 12v6"/><path d="M4.077 10.615A1 1 0 0 0 5 12h14a1 1 0 0 0 .923-1.385l-3.077-7.384A2 2 0 0 0 15 2H9a2 2 0 0 0-1.846 1.23Z"/><path d="M8 20a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v1a1 1 0 0 1-1 1H9a1 1 0 0 1-1-1z"/></svg>Solar streetlighting</li>
    ...
    <div className='Features-div2'>
    <div className='Features-div2-left'>
    <h3 className='Belleza'>Community features</h3>
    <p>Nirvaana Hills is where the beauty of the hills meets the warmth of community. It’s
...
<img src={Individual}/>
    ...
    <p>Here, every farmhouse opens to vast greens & complete privacy. From inviting pathways
...
provision</li>
      ...
      <div className='Features-div2'>
    <div className='Features-div2-left'>
    <h3 className='Belleza'>Clubhouse features
</h3>
    <p>Here’s where everyday life feels a little brighter. A place buzzing with energy, laughter,
