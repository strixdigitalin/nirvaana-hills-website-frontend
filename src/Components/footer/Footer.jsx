                ...
                <div className="max-w-[1440px] w-full mx-auto">
                    <div className='grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 lg:gap-[50px] md:gap-[40px] gap-[20px]'>
                        <div >
                            ...
                            <div className="flex gap-[20px] md:gap-[30px] text-[#fff] text-[20px]">
                                ...
                                <Link to="https://www.nirvaanahills.com/">
                    ...
                    <div className='lg:pt-[70px] md:pt-[50px] pt-[30px]'>
                        <p className="font-[400] font-inter text-[14px] leading-[24px] text-center text-[#F9F7EF] lg:pb-[40px] md:pb-[30px] pb-[20px]">
                            © Official Page of Nirvaana Hills. We are not responsible for information shared by unofficial pages.  All rights reserved.
                        </p>
                    </div>
                </div>
            </div>
